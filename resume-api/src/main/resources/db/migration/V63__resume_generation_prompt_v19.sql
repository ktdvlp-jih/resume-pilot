-- 자소서 생성(RESUME_GENERATION) 프롬프트 v19
-- 문항별 경험 배정 + 전체 자소서 일관성(말투·사실 모순 금지, 같은 장면 반복 금지).
...
VALUES
(
    'b0000018-0001-0001-0001-000000000002',
...
WHERE prompt_template_id = 'a0000001-0001-0001-0001-000000000001'
  AND id <> 'b0000018-0001-0001-0001-000000000002';

UPDATE prompt_versions SET is_active = true
WHERE id = 'b0000018-0001-0001-0001-000000000002';

UPDATE prompt_templates
SET active_version_id = 'b0000018-0001-0001-0001-000000000002', updated_at = NOW()
