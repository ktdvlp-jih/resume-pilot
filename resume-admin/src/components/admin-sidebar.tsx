...
import { Building2, Briefcase, Bot, CreditCard, FileText, Link2, LogOut, Package, ScrollText, Settings2, ShieldBan, Sparkles, Ticket, Users, Wallet } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/coupons', icon: Ticket, key: 'nav.coupons', kind: 'full' },
