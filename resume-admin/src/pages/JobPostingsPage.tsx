...
export default function JobPostingsPage() {
  ...
  const canUpload =
    sourceType === 'URL' ? sourceUrl.trim().length > 0 : title.trim().length > 0 && content.trim().length > 0;
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {sourceType === 'URL' ? (
            ...
            <div className="space-y-2">
              <Label>{t('jobPostings.content')}</Label>
              <Textarea
                value={content}
          ...
          <div className="space-y-2">
            <Label>{sourceType === 'TEXT' ? t('jobPostings.titleRequired') : t('jobPostings.titleOptional')}</Label>
