...
const OPERATION_ORDER = ['GENERATE', 'JOB_ANALYSIS', 'AI_DETECTION', 'AI_HUMANIZE', 'AI_REVIEW', 'INTERVIEW_QUESTIONS', 'KEYWORD_COMPARE', 'PORTFOLIO_REVIEW', 'SECTION_ANALYSIS', 'EXPERIENCE_CHAT', 'HELP_CHAT', 'EMBEDDING'];
